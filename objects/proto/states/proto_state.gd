...
const ANIM_HURT_GROUND_EP : StringName = &"hurt_e_ground"
const ANIM_HURT_AIR : StringName = &"hurt_air"
const ANIM_HURT_AIR_EP : StringName = &"hurt_e_air"
...
const TRANS_HURT_TYPE_HP : String = "hp"
const TRANS_HURT_TYPE_EP : String = "ep"
...
const APARAM_TRANS_HURT_TYPE : String = "parameters/hurt_type/transition_request"
const APARAM_TRANS_HURT_TYPE_CURRENT : String = "parameters/hurt_type/current_state"
